import{g as n}from"./index-CB87Sc6I.js";import{S as d}from"./sweetalert2.esm.all-BoFtKDfH.js";const e=window.jQuery;e.ajaxSetup({headers:{"X-CSRF-TOKEN":e('meta[name="csrf-token"]').attr("content")}});e(document).ready(function(){let c=[],r=[],f="cards",p="create";e(".js-example-basic-single").select2({width:"100%",placeholder:"Select a policy series to view details...",allowClear:!0}),y(),w(),setTimeout(function(){e('.toggle-btn[data-view="cards"]').trigger("click")},100),e("#loadDataBtn").on("click",function(){w()}),e("#create_new").on("click",function(){openCreateModal()}),e(".toggle-btn").on("click",function(){f=e(this).data("view"),e(".toggle-btn").removeClass("active"),e(this).addClass("active"),e("#cardView").hide(),e("#tableView").hide(),e("#series-table-container").hide(),e("#cardView").removeClass("active cards-view grid-view list-view"),f==="cards"?(e("#cardView").addClass("cards-view active").show(),h(r)):f==="grid"?(e("#cardView").addClass("grid-view active").show(),h(r)):f==="table"&&(e("#tableView").addClass("active").show(),b(r))}),e("#statusFilter").on("change",function(){let t=e(this).val();x(t)}),e("#resetFilters").on("click",function(){e("#statusFilter").val("all"),x("all")}),e("#seriesForm").on("submit",function(t){t.preventDefault(),T()});function y(){e.ajax({url:window.seriesRoutes.stats,type:"GET",dataType:"json",success:function(t){e("#totalSeries").text(t.total),e("#activeSeries").text(t.active),e("#inactiveSeries").text(t.inactive)}})}function w(){e.ajax({url:window.seriesRoutes.data,type:"GET",dataType:"json",success:function(t){c=t.data||[],r=c,h(r),b(r)},error:function(){console.log("Error loading series")}})}function x(t){t==="all"?r=c:t==="active"?r=c.filter(a=>a.status==1):t==="inactive"&&(r=c.filter(a=>a.status==0)),r.length===0&&t!=="all"?(e("#cardView").addClass("hidden"),e("#tableView").addClass("hidden"),e("#filteredEmptyState").removeClass("hidden")):(e("#cardView").removeClass("hidden"),e("#tableView").removeClass("hidden"),e("#filteredEmptyState").addClass("hidden"),f==="cards"||f==="grid"||f==="list"?h(r):b(r))}function h(t){if(t.length===0){e("#cardView").html(`
            ...
            `}),e("#cardView").html(a),_()}function b(t){const a=window.userId===1&&window.userOfficeId===0;if(t.length===0){const i=a?9:8;e("#tableBody").html(`
                <tr>
                    <td colspan="${i}">
                        <div class="empty-state">
                            <div class="empty-icon">
            ...
            `),e("#create_new_empty_table").on("click",function(){openCreateModal()});return}let s="";t.forEach(function(i,o){const l=i.status==1?"active":"inactive",u=i.status==1?"Active":"Inactive",m=i.type==0?"Pacific":i.type==1?"Liberty":"Stronghold",g=new Date(i.created_at).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}),v=i.office?i.office.office_name:"N/A",S=a?`<td>${v}</td>`:"";s+=`
