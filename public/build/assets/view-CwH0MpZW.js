function T(){const e=document.getElementById("img-thumb-path");if(!e)return;const n=document.createElement("div");n.style.cssText=`
    ...
    `,a.onclick=()=>document.body.removeChild(n),n.onclick=o=>{o.target===n&&document.body.removeChild(n)},i.appendChild(t),i.appendChild(a),n.appendChild(i),document.body.appendChild(n)}window.verifyDataAndOpenWindow=function(){var n;const e=((n=window.authData)==null?void 0:n.userCredit)||0;Swal.fire({title:'<span style="color: #4f46e5;">Fetching Client Data</span>',imageUrl:"https://i.pinimg.com/originals/3a/81/05/3a8105197bf6472fa8e825c06a3e5041.gif",imageWidth:180,imageHeight:120,imageAlt:"Loading",html:`
        ...
        `,didOpen:()=>{let i=0;const t=document.getElementById("progress-bar"),a=setInterval(()=>{i+=Math.random()*10+5,i>=100&&(i=100,clearInterval(a)),t.style.width=`${i}%`},200)}}),setTimeout(()=>{var u,c,p,f,g,w,v;var i=((u=window.authData)==null?void 0:u.clientName)||"",t=((c=window.authData)==null?void 0:c.clientAddress)||"",a=((p=window.authData)==null?void 0:p.plateNo)||"",o=((f=window.authData)==null?void 0:f.mvFileNo)||"",l=((g=window.authData)==null?void 0:g.cocNo)||"",s=((w=window.authData)==null?void 0:w.orNo)||"",r=((v=window.authData)==null?void 0:v.policyNo)||"";l=l.toUpperCase(),document.getElementById("loadingClientName").textContent=i||"No data available",document.getElementById("loadingClientAddress").textContent=t||"No data available",document.getElementById("loadingPlateNo").textContent=a||"No data available",document.getElementById("loadingMvFileNo").textContent=o||"No data available",setTimeout(()=>{if(e<=10){Swal.fire({title:'<span style="color: #ef4444;">Service Failed</span>',html:'<div style="text-align:center;"><i class="fas fa-exclamation-triangle" style="font-size:3rem;color:#ef4444;margin-bottom:1rem;"></i><p>Request Limit Reached Balance Uphold.</p></div>',icon:"error",confirmButtonText:"OK",customClass:{confirmButton:"swal2-confirm-error"}});return}if(/(\.{2,})|[-\/]{2,}|,{2,}|`{2,}/.test(i)){Swal.fire({title:'<span style="color: #ef4444;">Invalid Name Format</span>',html:`<div style="text-align:center;">
                          ...
                          </div>`,showCancelButton:!0,confirmButtonText:"Edit Name",cancelButtonText:"Cancel",customClass:{confirmButton:"swal2-confirm-error"}}).then(h=>{h.isConfirmed&&window.openEditModal()});return}if(l>=1&&l<=200){O(i,t,a,o,l,s,r);return}if(l.length===6&&l.startsWith("87")){R(i,t,a,o,l,s,r);return}B(i,t,a,o,l,s,r)},1e3)},1500)};function B(e,n,i,t,a,o,l){Swal.close();var s=`
    ...
    `;Swal.fire({title:'<span style="color: #4f46e5;">Confirm Details</span>',html:`
            ...
            ${s}
        `,imageUrl:null,showCancelButton:!0,confirmButtonText:"Confirm & Proceed",cancelButtonText:"Review Details",focusConfirm:!1,allowOutsideClick:!1,backdrop:"rgba(79, 70, 229, 0.08)"}).then(r=>{var u;if(r.isConfirmed){const c={log:`Generated Authentication with Confirmation of Cover Bearing No: "${a}" to MV file No. : "${t}"`,session:((u=window.authData)==null?void 0:u.userFullname)||"System"};fetch("insert_log.php",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams(c).toString()}).then(p=>p.text()).then(p=>console.log("Log saved:",p)).catch(p=>console.error("Error saving log:",p)),P(a,o,l),L(a)}}),document.querySelectorAll(".client-detail").forEach((r,u)=>{setTimeout(()=>{r.style.opacity="1",r.style.transform="translateY(0)"},100*u)})}function P(e,n,i){var b,m,d,C,I,E,k,N,S;var t=((b=window.authData)==null?void 0:b.clientName)||"",a=((m=window.authData)==null?void 0:m.clientAddress)||"",o=((d=window.authData)==null?void 0:d.plateNo)||"",l=((C=window.authData)==null?void 0:C.mvFileNo)||"",s=((I=window.authData)==null?void 0:I.chassisNo)||"",r=((E=window.authData)==null?void 0:E.engineNo)||"",u=((k=window.authData)==null?void 0:k.clientName)||"",c=((N=window.authData)==null?void 0:N.clientAddress)||"",p=((S=window.authData)==null?void 0:S.insuranceId)||"",f="https://primeone.com.ph/issuance?";f+="assured_name="+encodeURIComponent(t),f+="&assured_address="+encodeURIComponent(a),f+="&plate_no="+encodeURIComponent(o),f+="&mvfile_no="+encodeURIComponent(l),f+="&chassis_no="+encodeURIComponent(s),f+="&motor_no="+encodeURIComponent(r),f+="&fullname="+encodeURIComponent(u),f+="&address="+encodeURIComponent(c),f+="&or_no="+encodeURIComponent(n),f+="&coc_no="+encodeURIComponent(e),f+="&policy_no="+encodeURIComponent(i);var g=Math.floor(screen.width*.49),w=Math.floor(screen.width*.01),v=`width=${g},height=${screen.height},scrollbars=yes,resizable=yes,toolbar=no,location=no`,h=window.open(`/authenticate/index?id=${p}`,"authWindow",`${v},left=0,top=0`),y=window.open(f,"ectplWindow",`${v},left=${g+w},top=0`);h?(h.focus(),console.log("Authentication window opened successfully")):(console.error("Popup blocker may be preventing the authentication window from opening"),alert("Please allow popups for this site to continue")),y?(y.focus(),console.log("ECTPL window opened successfully")):console.error("Popup blocker may be preventing the ECTPL window from opening"),window.addEventListener("resize",function(){h&&!h.closed&&h.resizeTo(Math.floor(screen.width*.48),screen.height),y&&!y.closed&&(y.resizeTo(Math.floor(screen.width*.48),screen.height),y.moveTo(Math.floor(screen.width*.48)+w,0))})}function O(e,n,i,t,a,o,l){Swal.fire({title:'<span style="color: #ef4444;">Invalid COC Number</span>',html:`
        ...
        `,showCancelButton:!0,confirmButtonText:"Submit",cancelButtonText:"Cancel",focusConfirm:!1,preConfirm:()=>{if(!document.getElementById("enableBypassMode").checked)return Swal.showValidationMessage("You must enable bypass mode to proceed"),!1;const r=document.getElementById("orNoInput").value,u=document.getElementById("cocNoInput").value,c=document.getElementById("policyNoInput").value;return!/^\d{8}$/.test(r)||!/^\d{8}$/.test(u)||!/^\d{8}$/.test(c)?(Swal.showValidationMessage("All fields must contain exactly 8 digits"),!1):{cocNo:u,orNo:r,policyNo:c}}}).then(s=>{s.isConfirmed&&(a=s.value.cocNo,o=s.value.orNo,l=s.value.policyNo,B(e,n,i,t,a,o,l))}),document.getElementById("enableBypassMode").addEventListener("change",function(){const s=document.getElementById("formFields"),r=Swal.getConfirmButton();this.checked?(s.classList.add("visible"),r.disabled=!1):(s.classList.remove("visible"),r.disabled=!0)})}function R(e,n,i,t,a,o,l){Swal.fire({title:'<span style="color: #f59e0b;">Milestone COC Detected</span>',html:`
            <div style="text-align:center;margin-bottom:1.5rem;">
        ...
        `,showCancelButton:!0,confirmButtonText:"Update",cancelButtonText:"Cancel",focusConfirm:!1,preConfirm:()=>{const s=document.getElementById("cocNoInput").value.toUpperCase();return/^[A-Z]\d{6}$/.test(s)?s:(Swal.showValidationMessage("COC must start with a letter followed by 6 digits (e.g. J123456)"),!1)}}).then(s=>{s.isConfirmed&&(a=s.value,B(e,n,i,t,a,o,l))})}function L(e){const n=`authCheck_${e}`,i=localStorage.getItem(n);if(i){const t=JSON.parse(i);if(t.isActive&&t.timestamp&&Date.now()-t.timestamp<3e5){D(e,t.timeLeft,t.currentAuthCode);return}else localStorage.removeItem(n)}D(e,300,null)}function D(e,n,i){let t,a,o=n,l=i,s=!1,r=!1;const u=`authCheck_${e}`,c=()=>{localStorage.setItem(u,JSON.stringify({isActive:!s&&o>0,timeLeft:o,currentAuthCode:l,timestamp:Date.now(),clientcoc:e}))},p=m=>{const d=Math.floor(m/60),C=m%60;return`${d}:${C<10?"0":""}${C}`},f=m=>{if(!s&&o>0)return c(),m.preventDefault(),m.returnValue="You have an ongoing authentication process. Your progress will be saved.",m.returnValue},g=m=>{!s&&o>0&&(m.ctrlKey&&(m.key==="r"||m.key==="R")||m.key==="F5")&&(r||(h(),r=!0,setTimeout(()=>{r=!1},1e3)),m.preventDefault())};let w=Date.now();const v=()=>{!s&&o>0&&(document.hidden?Date.now()-w>1e3&&y():w=Date.now())},h=()=>{Swal.fire({title:"Authentication in Progress",html:`<div style="text-align: left;">
