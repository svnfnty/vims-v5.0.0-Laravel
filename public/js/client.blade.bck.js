                ...
                <div class="client-card" data-status="${status}" data-office="${officeName}" data-id="${client.id}">
                    ...
                    <div class="card-footer">
                        <div class="action-buttons">
                            ...
                            ${window.userPermissions > 0 ? `<button class="action-btn-small edit edit_data" data-id="${client.id}">
                                <i class="fas fa-edit"></i>
                                Edit
                            </button>` : ''}
                            ${window.userPermissions === 1 ? `<button class="action-btn-small delete delete_data" data-id="${client.id}">
    ...
    function submitClientForm() {
        ...
        $.ajax({
            ...
            complete: function() {
                ...
                $submitBtn.prop('disabled', false).html('<i class="fas fa-save"></i> ' + (currentMode === 'create' ? 'Save Client' : 'Update Client'));
            }
        });
    }
